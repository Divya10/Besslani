...
public class MyBookingsAdapter extends Adapter<MyBookingsAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View listItem= layoutInflater.inflate(R.layout.your_bookings_list_item, parent, false);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(view.getContext(),"click on item: "+mybookingsdata.getDescription(),Toast.LENGTH_LONG).show();
                }
            });
        }
